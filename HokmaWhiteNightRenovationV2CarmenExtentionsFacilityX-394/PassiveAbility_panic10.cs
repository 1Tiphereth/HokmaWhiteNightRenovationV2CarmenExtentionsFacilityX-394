...
{
    public class PassiveAbility_panic10 : PassiveAbilityBase
    {
        public override void OnRoundEnd_before()
        {
            ...
            {
                owner.bufListDetail.AddKeywordBufThisRoundByEtc(KeywordBuf.Burn, 5);
                owner.bufListDetail.AddKeywordBufThisRoundByEtc(KeywordBuf.Disarm, 5);
