...
{
    public class DiceCardSelfAbility_allyBaral : DiceCardSelfAbilityBase
    {
        public class BattleUnitBuf_zenaSpawner : BattleUnitBuf
        {
            public override void OnRoundEndTheLast()
            {
                ...
                if (flag3)
                {
                    ...
                    battleUnitModel.emotionDetail.SetEmotionLevel(5);
                    battleUnitModel.allyCardDetail.DrawCards(8);
                    battleUnitModel.cardSlotDetail.RecoverPlayPoint(battleUnitModel.cardSlotDetail.GetMaxPlayPoint());
                    battleUnitModel.view.ChangeSkin("TheClaw");
        ...
        {
            UnitDataModel unitDataModel = new UnitDataModel(new LorId(Init.packageName, 4), floor.Sephirah, false);
            unitDataModel.SetTempName("Baral");
